...
export interface ThemeCollectionOrderFieldProps {
    label: string;
    defaultValue: number | null;
    onEditFinish: (value: number | null) => void;
}

export function ThemeCollectionOrderField({ label, onEditFinish, defaultValue }: ThemeCollectionOrderFieldProps) {
    ...
    return (
        <SpaceStyled size="small" align="center" onClick={enableEditing}>
            ...
            {editing ? (
                ...
                <Typography.Text strong>{defaultValue ?? "--"}</Typography.Text>
            )}
        </SpaceStyled>
    );
}
