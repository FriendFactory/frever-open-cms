...
import { exportLocalizationCSV } from "../services/exportLocalizationCSV";

export interface LocalizationExportProps {}

export const LocalizationExport = ({}: LocalizationExportProps) => {
    ...
    const handleDownload = async () => {
        try {
            ...
            link.href = url;
            link.download = `onboarding-localization-${stage}.csv`;
