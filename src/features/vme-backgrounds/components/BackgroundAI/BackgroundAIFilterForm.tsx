...
export interface BackgroundAIFilterFormFormProps {
    form: FormInstance<BackgroundAIQueryParams>;
    initialValues: BackgroundAIQueryParams;
    onSearch: () => void;
    onChangeSortDirection: () => void;
}

export function BackgroundAIFilterFormForm({
    form,
    initialValues,
    onSearch,
    onChangeSortDirection
}: BackgroundAIFilterFormFormProps) {
    return (
